...
import asyncio
import time
from ZEEMUSIC.utils.database import add_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from ZEEMUSIC.utils.database import get_assistant
import asyncio
from ZEEMUSIC.misc import SUDOERS
from ZEEMUSIC.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
from ZEEMUSIC.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("ZEEMUSIC/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((500, 500))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('ZEEMUSIC/assets/font.ttf', size=60)
    welcome_font = ImageFont.truetype('ZEEMUSIC/assets/font.ttf', size=60)
