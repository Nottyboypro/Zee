...
# Bot and owner info
OWNER_USERNAME = getenv("OWNER_USERNAME", "Nottyboyy")
BOT_USERNAME = getenv("BOT_USERNAME", "ZeeMusicBot")
BOT_NAME = getenv("BOT_NAME", "ZEE")
...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Nottyboypro/Zee")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ZeeMusicUpdate")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ZeeMusicSupport")
